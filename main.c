...
void main(void)
{
    ...
    lcd_display_string("MISS U");
    /*create the tasks*/
    xTaskCreate(switches_update    ,"switches_update"   , configMINIMAL_STACK_SIZE , NULL , 5 , NULL                  ) ;
    ...
    xTaskCreate(temperature_update ,"temperature_update", configMINIMAL_STACK_SIZE , NULL , 0 , &TaskHandle_temp      );
